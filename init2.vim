...
" Remaps = to + to make it easier to jump to the first non-whitespace
" character on the next line
" We format on save/commit so we don't need = for that
" (- jumps to first non-whitespace character on previous line)
map = +
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Auto folds
" Python doesn't have folding rules built into its Vim syntax file
" So we use indents instead
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => Plugins
" To install plugin, add the line and run :PlugInstall
" To remove plugin, remove the line, source vimrc and run :PlugClean
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
call plug#begin()
...
" For rust - needs to be after plugin manager load
syntax enable
